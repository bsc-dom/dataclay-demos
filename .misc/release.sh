...
find $SCRIPTDIR -type f -exec sed -i 's/module load DATACLAY/develop\/develop/module load DATACLAY/develop/g' {} \;
find $SCRIPTDIR -type f -exec sed -i 's/module load COMPSs/Trunk\/Trunk/module load COMPSs/Trunk/g' {} \;
...
find $SCRIPTDIR -type f -exec sed -i 's/module load DATACLAY/develop/module load DATACLAY/develop\/develop/g' {} \;
find $SCRIPTDIR -type f -exec sed -i 's/module load COMPSs/Trunk/module load COMPSs/Trunk\/Trunk/g' {} \;
