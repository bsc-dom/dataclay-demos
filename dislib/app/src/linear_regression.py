...
def linear_regression(use_dataclay):
    import numpy as np
    ...
    bn, bm = 2, 2
    x = ds.array(x=x_data, block_size=(bn, bm), use_dataclay=use_dataclay)
    y = ds.array(x=y_data, block_size=(bn, bm), use_dataclay=use_dataclay)
    ...
    test_data = ds.array(x=x_test, block_size=(bn, bm), use_dataclay=use_dataclay)
