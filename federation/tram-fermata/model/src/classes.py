...
class Fermata(DataClayObject):
    """
    @ClassField name str
    @ClassField camera_left DemoNS.classes.CameraInFermata
    @ClassField semaforo_left DemoNS.classes.SemaforoInFermata
    @ClassField camera_right DemoNS.classes.CameraInFermata
    @ClassField semaforo_right DemoNS.classes.SemaforoInFermata
    @ClassField trams dict<str,DemoNS.classes.Tram>
    """
    ...
    @dclayMethod(tram='DemoNS.classes.Tram')
    ...
    @dclayMethod(return_='dict<str,DemoNS.classes.Tram>')        
    def get_trams(self):
        return self.trams
        
    @dclayMethod(return_='DemoNS.classes.SemaforoInFermata')
    def get_semaforo_left(self):
        return self.semaforo_left

    @dclayMethod(return_='DemoNS.classes.CameraInFermata')
