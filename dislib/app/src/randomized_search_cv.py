...
def randomized_search_cv(use_dataclay):
    import numpy as np
    ...
    x = ds.array(x_np[p], (30, 4), use_dataclay=use_dataclay)
    y = ds.array((y_np[p] == 0)[:, np.newaxis], (30, 1), use_dataclay=use_dataclay)
