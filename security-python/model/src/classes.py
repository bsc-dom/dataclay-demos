...
class Event(DataClayObject):
    ...
    @dclayMethod(event_type='int', timestamp='str', position='DemoNS.classes.Position')
...
class City(DataClayObject):
    ...
    @ClassField aggregation DemoNS.classes.AggregatedEvents
    """
    ...
    @dclayMethod(new_events="list<DemoNS.classes.Event>")
    def add_all_events(self, new_events):
        self.events.extend(new_events)
        
    @dclayMethod(return_="DemoNS.classes.AggregatedEvents")
...
class EventsInCar(DataClayObject):
    """
    @ClassField events dict<DemoNS.classes.Position, DemoNS.classes.Event>
    """
