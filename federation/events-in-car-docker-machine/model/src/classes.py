...
class DKB(DataClayObject):
    """
    @ClassField KB dict<str, list<DemoNS.classes.ObjectKB>>
    @ClassField identifiedObjects list<DemoNS.classes.Event>
    @ClassField objectsInOSM dict<DemoNS.classes.Position, DemoNS.classes.Event>
    @ClassField objectsInAllegro list<DemoNS.classes.Event>
    """
    @dclayMethod()
    def __init__(self):
        self.KB = dict()
    ...
    @dclayMethod(event='DemoNS.classes.Event', subarea='str')
    ...
    @dclayMethod(event='DemoNS.classes.Event')
...
class ObjectKB(DataClayObject):
    ...
    @ClassField trafficFlow dict<str, DemoNS.classes.ObjectTrafficFlow>
...
class Event(DataClayObject):
    ...
    @ClassField pos DemoNS.classes.Position
    @ClassField dt anything
    @ClassField idEvent int
    @ClassField idClass int
    """
    @dclayMethod(eventType='anything', pos='DemoNS.classes.Position', dtime='anything', idEvent='int', idClass='int')
...
class Position(DataClayObject):
    ...
    @dclayMethod(other='DemoNS.classes.Position', return_='bool')
...
class EventsInCar(DataClayObject):
    """
    @ClassField events list<DemoNS.classes.Event>
    @ClassField eventsById dict<int, DemoNS.classes.Event>
    @ClassFIeld eventsByTS dict<int, DemoNS.classes.Event>
    """
    ...
    @dclayMethod(new_event="DemoNS.classes.Event")
...
class GlobalEventsInCar(DataClayObject):
    """
    @ClassField events list<DemoNS.classes.Event>
    @ClassField eventsById dict<int, DemoNS.classes.ObjMove>
